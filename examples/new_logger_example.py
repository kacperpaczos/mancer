...
def demo_basic_logging():
    ...
    logger.info("Wiadomość z kontekstem", {
        "user": "admin",
        "action": "login",
        "timestamp": time.time()
    })
...
def demo_pipeline_logging():
    ...
    logger.log_command_input(
        command_name="grep",
        data=["line1: important data", "line2: unimportant data", "line3: important stuff"]
    )
    ...
    logger.log_command_output(
        command_name="grep",
        data=["line1: important data", "line3: important stuff"]
    )
