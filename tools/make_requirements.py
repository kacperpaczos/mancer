...
STANDARD_LIBS = set([
    ...
    'copy', 'csv', 'datetime', 'decimal', 'difflib', 'enum', 'functools', 'getpass',
    'glob', 'hashlib', 'html', 'http', 'io', 'itertools', 'json', 'logging', 'math',
    'multiprocessing', 'os', 'pathlib', 'pickle', 'platform', 'random', 're', 'shutil',
    'signal', 'socket', 'sqlite3', 'ssl', 'statistics', 'string', 'subprocess', 'sys',
...
def main():
    ...
    parser.add_argument("prototype", nargs="?", help="Name of the prototype to generate requirements for")
