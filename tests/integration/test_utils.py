...
class MancerDockerTestUtils:
    ...
    @staticmethod
    def execute_bash_command_in_container(container_name: str, command: str, 
                                        working_dir: str = "/home/mancer1/mancer") -> Tuple[str, str, int]:
        """
    ...
    @staticmethod
    def execute_mancer_app_with_shell_runner(container_name: str, app_path: str, 
...
'''
            ...
            stdout, stderr, exit_code = MancerDockerTestUtils.execute_bash_command_in_container(
                container_name, f"python3 -c '{import_test}'", f"/home/mancer1/mancer/{app_path}"
            )
