...
from src.mancer.domain.shared.profile_producer import ConnectionProfile, ProfileProducer
...
def manage_services(systemd_service, profile_producer):
    ...
    result = systemd_service.manage_systemd_service(
        selected_profile.name, service_name, actions[action_choice]
    )
