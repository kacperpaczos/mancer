...
class SystemctlCommand(BaseCommand):
    ...
    def status(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "status").with_param("service", service),
        )
    ...
    def start(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "start").with_param("service", service),
        )
    ...
    def stop(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "stop").with_param("service", service),
        )
    ...
    def restart(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "restart").with_param("service", service),
        )
    ...
    def reload(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "reload").with_param("service", service),
        )
    ...
    def enable(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "enable").with_param("service", service),
        )
    ...
    def disable(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "disable").with_param("service", service),
        )
    ...
    def is_active(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "is-active").with_param("service", service),
        )
    ...
    def is_enabled(self, service: str) -> "SystemctlCommand":
        ...
        return cast(
            SystemctlCommand,
            self.with_param("command", "is-enabled").with_param("service", service),
        )
